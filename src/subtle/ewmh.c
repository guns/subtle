...
subEwmhInit(void)
{
  ...
  char *selection = NULL, *names[] =
  {
    ...
    "_NET_CLOSE_WINDOW", "_NET_RESTACK_WINDOW", 

    "_NET_WM_NAME", "_NET_WM_PID", "_NET_WM_DESKTOP", "_NET_SHOWING_DESKTOP",

    "_NET_WM_STATE", "_NET_WM_STATE_HIDDEN", "_NET_WM_STATE_FULLSCREEN", "_NET_WM_STATE_ABOVE", 
    "_NET_WM_STATE_STICKY",

    "_NET_WM_WINDOW_TYPE", "_NET_WM_WINDOW_TYPE_DESKTOP", "_NET_WM_WINDOW_TYPE_NORMAL", 
