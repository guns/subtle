...
subEwmhInit(void)
{
  ...
  char *selection = NULL, *names[] =
  {
    ...
    "_NET_WM_WINDOW_TYPE", "_NET_WM_WINDOW_TYPE_DIALOG", "_NET_WM_WINDOW_TYPE_DOCK",
    "_NET_WM_WINDOW_TYPE_DESKTOP",

    /* States */
    "_NET_WM_STATE", "_NET_WM_STATE_FULLSCREEN", "_NET_WM_STATE_ABOVE",
    "_NET_WM_STATE_STICKY", "_NET_WM_STATE_MODAL",
    ...
    "SUBTLE_WINDOW_RETAG", "SUBTLE_WINDOW_GRAVITY", "SUBTLE_WINDOW_SCREEN",
    ...
    "SUBTLE_SUBLET_BACKGROUND", "SUBTLE_SUBLET_LIST", "SUBTLE_SUBLET_WINDOWS",
    "SUBTLE_SUBLET_KILL", "SUBTLE_RELOAD_CONFIG", "SUBTLE_RELOAD_SUBLETS",
    "SUBTLE_RESTART", "SUBTLE_QUIT", "SUBTLE_COLORS"
  };
