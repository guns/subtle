...
GRAVITIES = {
  ...
  :top_right    => [ [ 50,  0,   50,  50  ], [ 50, 0,  50,  66 ] ],
  :left         => [ [ 0,   0,   50,  100 ], [ 0,  33, 50,  33 ] ],
  :center       => [ [ 0,   0,   100, 100 ], [ 0,  33, 100, 33 ] ],
  :right        => [ [ 50,  0,   50,  100 ], [ 50, 33, 50,  33 ] ],
  :bottom_left  => [ [ 0,   50,  50,  50  ], [ 0,  34, 50,  66 ], [ 0,  67, 50,  33 ] ],
  :bottom       => [ [ 0,   50,  100, 50  ], [ 0,  34, 100, 66 ], [ 0,  67, 100, 33 ] ],
  :bottom_right => [ [ 50,  50,  50,  50  ], [ 50, 34, 50,  66 ], [ 50, 67, 50,  33 ] ]
}
